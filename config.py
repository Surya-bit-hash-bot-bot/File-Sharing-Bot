...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7998222748:AAENry2RX26PKBLsVBh_0iRA8UBddy9RdiI")
API_ID = int(os.environ.get("API_ID", "20478011"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002363573690"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002401311517"))
...
try:
    ADMINS=[2061656269]
    for x in (os.environ.get("ADMINS", "2061656269 5703128379").split()):
        ADMINS.append(int(x))
except ValueError:
